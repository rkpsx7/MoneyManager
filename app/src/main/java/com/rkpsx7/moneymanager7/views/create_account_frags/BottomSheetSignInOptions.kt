...
// Configure Google Sign In
            ...
            .addOnCompleteListener(this.requireActivity()) { task ->
                if (task.isSuccessful) {
                    ...
                    CoroutineScope(IO).launch {
                        ...
                        addUserToServer(name, email, profilePic, user.uid)
    ...
    private fun addUserToServer(name: String, email: String, pic: Bitmap, uid: String) {
        val imgB = bitMapToString(pic)
        val us = UserObjForServer(uid, name, email, imgB.toString())
